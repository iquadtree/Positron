...
masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Positron Nodes"), this);
 masternodeManagerAction->setToolTip(tr("Show Positron Nodes status and configure your nodes."));
